...
%%
experiment2.base_dir = [base_dir '10_step_multi_model/'];
experiment2.error = load( [experiment2.base_dir 'error.txt'] );
experiment2.name = ['10 Step Multi-model' repmat(char(3), 1, 1)];
...
experiment1.name = ['10 Step Single-model' repmat(char(3), 1, 2)];
...
output_name = ['output_images/' experiment '/10-step-multimodel-comparison.eps' ];
